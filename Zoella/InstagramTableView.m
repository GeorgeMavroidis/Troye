...
@implementation InstagramTableView
...
-(void)fetchFeeds{
    ...
    NSString *posts_url = [NSString stringWithFormat:@"http://thewotimes.com/Y/current.php?user=%@&type=instagram&get=true", USER];
...
//    items = json_dic;
    ...
    NSUserDefaults *d = [NSUserDefaults standardUserDefaults];
    [d setObject:tdata forKey:@"instagram"];
...
-(void)loadFeedFor:(NSString *)page{
    ...
    NSUserDefaults *d = [NSUserDefaults standardUserDefaults];
    items = [NSJSONSerialization JSONObjectWithData:[d objectForKey:@"instagram"] options:0 error:nil];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [CreationFunctions tableView:tableView heightForInstagram:indexPath singleton:items];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell = [CreationFunctions createInstagramCell:tableView cellForRowAtIndexPath:indexPath singleton:items];
